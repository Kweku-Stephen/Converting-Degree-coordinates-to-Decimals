#This was specifically designed to ignore uncertainties in the data presented for the computation
#So instead of the main function of this body of code (dc_dg) to accept a vector of length > 1, it only
#accepts a vector of length 1 since some elements within the data  may not
#have been recorded or entered correctly ie. some deviate from the the format " N9°23'17.3256'' "
...
#An Alternative approach to improve speed
